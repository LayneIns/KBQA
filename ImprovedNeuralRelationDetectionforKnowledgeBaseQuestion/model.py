...
class HrbilstmModel:
	...
	def __init__(self, arg_config):
		...
		# [1, one_case_length]
		self.score = tf.add(arg_config.gamma, tf.reduce_sum(tf.multiply(self.cos_similarity, self.label_sequence)))
		# [1, 1]
		...
		self.max_sim_index = tf.argmax(self.cos_similarity)
